...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    @register(dispatch_mode=make_nd_compute_dataproto_dispatch_fn(mesh_name="actor"))
    @DistProfiler.annotate(color="blue", role="actor_compute_log_prob_h")
    def compute_log_prob_h(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            with adapter_ctx:
                output, entropys, W, b, preds, weights, weighted_advantages = self.actor.compute_log_prob_h(data=data, calculate_entropy=not is_lora)
            ...
            tensors["weighted_adv"] = weighted_advantages

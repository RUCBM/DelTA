...
class SupportedModel(Enum):
    ...
    QWEN3_5 = "Qwen3_5ForConditionalGeneration"  # Qwen3.5 model
    QWEN3_5_CAUSAL_LM = "Qwen3_5ForCausalLM"  # Qwen3.5 causal LM
...
MODEL_CONFIG_CONVERTER_REGISTRY: dict[SupportedModel, Callable[[PretrainedConfig, torch.dtype], TransformerConfig]] = {
    ...
    SupportedModel.QWEN3_5: hf_to_mcore_config_dense,  # Qwen3.5 uses same config as Qwen3
    SupportedModel.QWEN3_5_CAUSAL_LM: hf_to_mcore_config_dense,  # Qwen3.5 causal LM
...
MODEL_INITIALIZER_REGISTRY: dict[SupportedModel, type[BaseModelInitializer]] = {
    ...
    SupportedModel.QWEN3_5: DenseModel,  # Qwen3.5 uses DenseModel
    SupportedModel.QWEN3_5_CAUSAL_LM: DenseModel,  # Qwen3.5 causal LM uses DenseModel
...
MODEL_FORWARD_REGISTRY: dict[SupportedModel, Callable] = {
    ...
    SupportedModel.QWEN3_5: model_forward_gen(),  # Qwen3.5
    SupportedModel.QWEN3_5_CAUSAL_LM: model_forward_gen(),  # Qwen3.5 causal LM
...
MODEL_FORWARD_NOPAD_REGISTRY: dict[SupportedModel, Callable] = {
    ...
    SupportedModel.QWEN3_5: gptmodel_forward_no_padding,  # Qwen3.5
    SupportedModel.QWEN3_5_CAUSAL_LM: gptmodel_forward_no_padding,  # Qwen3.5 causal LM
...
MODEL_FORWARD_FUSED_REGISTRY: dict[SupportedModel, Callable] = {
    ...
    SupportedModel.QWEN3_5: fused_forward_model_gen(),  # Qwen3.5
    SupportedModel.QWEN3_5_CAUSAL_LM: fused_forward_model_gen(),  # Qwen3.5 causal LM
...
MODEL_WEIGHT_CONVERTER_REGISTRY: dict[SupportedModel, type] = {
    ...
    SupportedModel.QWEN3_5: McoreToHFWeightConverterDense,  # Qwen3.5
    SupportedModel.QWEN3_5_CAUSAL_LM: McoreToHFWeightConverterDense,  # Qwen3.5 causal LM
